...
//    public CourseOffer getCourseOfferById(String id) {
//        for (CourseOffer co : schedule) {
//            if (co.getCourseNumber().equals(id)) {
//                return co;
//            }
//        }
//        return null;
//    }
    public CourseOffer getCourseOfferById(String id) {
        for (CourseOffer co : schedule) {
            if (co.getCourseNumber().equals(id)) { // Assuming getId() returns the unique identifier of the course offer
                return co;
            }
        }
        return null;
